  ...
  return (
    <>
      ...
      <Dialog open={openModal} onOpenChange={setOpenModal}>
        {selectedRecord && (
          <DialogContent className="min-w-[85vw] w-[90vw] overflow-hidden max-h-[95vh] p-0">
            <div className="sticky top-0 z-10 bg-background p-6 border-b">
              <DialogHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <DialogTitle className="text-2xl">{selectedRecord.name}</DialogTitle>
                    <DialogDescription>
                  ...
                  <Badge 
                    ...
                    className="text-md px-3 py-1 h-auto"
                  >
            ...
            <div className="p-4 overflow-y-auto max-h-[calc(95vh-180px)]">
              <Tabs defaultValue="sensors" className="w-full" onValueChange={setActiveTab} value={activeTab}>
                <TabsList className="grid grid-cols-5 mb-2">
                  ...
                  <TabsTrigger value="device_control" className="flex items-center gap-2">
                    <WrenchIcon size={16} />
                ...
                <TabsContent value="camera" className="mt-0">
                  <Card>
                    ...
                    <CardContent>
                      {"https://streamsync-7yp3.onrender.com/live/c63ca337" ? (
                        <div className="relative rounded-lg overflow-hidden h-90">
                          <img 
                            src="https://streamsync-7yp3.onrender.com/live/c63ca337" 
